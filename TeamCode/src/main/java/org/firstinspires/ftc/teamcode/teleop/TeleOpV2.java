...
public class TeleOpV2 extends LinearOpMode {
    ...
    private void initSensor() {
        pitchTouchSensor = new goBildaTouchDriver(hardwareMap.get(DigitalChannel.class, "touchSensor"));
...
//        }
        this.turret.setPower(0.7*(-gamepad1.left_trigger + gamepad1.right_trigger - 0.5*gamepad2.left_trigger + 0.5*gamepad2. right_trigger));
