...
@Autonomous
public class RightClosePoleAuton extends LinearOpMode {
    OpenCvCamera camera;
...
//                targetTurretPosition = 0.55;
                sleep(125);
                intakeBack();
                targetTurretPosition = 0.5;
                targetPitchPosition = 0.42;
                sleep(600);
                this.clawOpen = true;
                sleep(400);
                targetPitchPosition = 0.71;
                if(j == 0) break;
                preIntakeMode(j);
                this.scoreClose();
                while(!linSlideCheck()){
...
//        frontArmPosition = 0;
        ...
        targetArmPosition = 0.2;
    }
    private void scorePt2(){
        linSlideUp();
        sleep(100);
        sleep(450);
    ...
    private void scoreClose(){
        this.targetTurretPosition = 0.33;
        sleep(400);

        linSlidePosition = 2;
        sleep(200);
        this.targetDepositPosition = 0.9;
        sleep(100);
        while(!linSlideCheck()){
            sleep(1);
        }
